...
update_all: template_update.ps1 template.html index.html
	...
	powershell $(update_header_command) 'Projects' 'projects/index.html'
	powershell $(update_nav_command) 'inactive,active,inactive' 'projects/index.html'

	powershell $(update_header_command) 'About' 'about/index.html'
	powershell $(update_nav_command) 'inactive,inactive,active' 'about/index.html'
